...
import { SignUpEmailMethod } from "./_components/signup-email-method";
import { SignUpMethods } from "./_components/signup-methods";
    ...
    <div className="flex h-full w-full flex-1 flex-col items-center justify-center gap-4">
      ...
      <AnimatePresence mode="popLayout">
        {step === "email" ? (
          ...
          >
            <SignUpEmailMethod onBack={() => setStep("methods")} />
          </motion.div>
        ) : (
          <motion.div
            key="select"
